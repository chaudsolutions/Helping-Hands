  ...
  return (
    <div className="about">
      ...
      <div className="about-paragraphs">
        ...
        <p>
          At Helping Hands, we believe in the potential of every person to make
          a difference. Whether you&apos;re looking to fund a personal project,
          support a charitable cause, or help a friend in need, our platform is
          designed to connect you with a global network of compassionate
          supporters. We make it easy for you to share your story, set your
          goals, and achieve the support you need to succeed.
        </p>

        <p>
          Since our inception, we&apos;ve been committed to transparency,
          integrity, and innovation. Our user-friendly interface, secure
          transactions, and dedicated support team ensure that both fundraisers
          and donors have a seamless experience. We are proud to be a part of
          numerous success stories that have transformed lives and communities
          around the world.
        </p>
